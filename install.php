...
<br>数据库名(请不要修改):<br>
<input type='text' name='db' value='ov'/><br/>
<br>管理员用户名:<br>
...
（如果已事先填写好config.php相关数据库配置，请 <a href="{$_SERVER['PHP_SELF']}?do=3">点击此处</a> 跳过这一步！</div>）
HTML;
}elseif($do=="1"){
...
?>';
		...
		echo "保存成功!<br><a href='{$_SERVER['PHP_SELF']}?do=3'>下一步</a>";
